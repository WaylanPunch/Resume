...
public class WordGenerator {
	...
	public void createDoc(List<Basic_info> basic_info, List<Educational_info> educational_info,
		...
		String exportFilePath = "E:\\WORKSPACE\\Eclipse_Workspace\\outFile.doc";// 文件导出路径，为doc格式
		Template t = null;
		// 1、导入模板
		configuration.setClassForTemplateLoading(this.getClass(), "/com/way/resume/modelPath");
